<template>
  <div id="app">
    ...
    <footer :class="['footer', isHomePage ? 'white' : '']">
      ...
      <p>
        Сделано с
        <svg class="love" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.003 512.003">
        ...
        на Урбатоне &#169; Потом придумаем, 2019
      </p>
    </footer>
  </div>
</template>
